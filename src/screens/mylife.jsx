...
import { AbilityFileList, AbilityGrid, CondFc, CourseRecordsPanel, FatigueBar, PersonaLine, StartListPanel, SubStatLine, TitlesPanel, TraitLine } from "../components/panels.jsx";
      ...
      return mlWrap(
        <div style={{ display: "grid", gap: 14 }}>
          ...
          <Section color={"#e8a13c"} title="モニュメント（ワンデー・クラシック）">
            ...
            <Card>🪨 モニュメントに2回出走すると、古典適性の特殊能力<span style={{ color: "#e8a13c" }}>「石畳巧者」</span>に開眼することがあります（モニュメント本番で全能力+5%）。さらにモニュメントを2勝すると金特に進化し、消耗戦での底上げが+9%に強化されます。古典を狙うなら育てたい一芸です。</Card>
          </Section>
