...
// hold:ほぼ中立〜やや不利の守り（エースが集団で勝てるなら不要）／ace_early:検証したどの局面でも
// 着順を大きく落とす高リスク（被圧倒時ですら救いにならず）＝基本は決め打ちの一発狙い。
export const CHASE_MODES = {
  ...
  ace_early: { label: "エース早期発射", desc: "エースが単独で飛び出す大博打。集団に吸収されて大失速しやすく、多くの局面で着順を落とす（1回限り）。決まれば独走だが基本は一発狙い" },
};
