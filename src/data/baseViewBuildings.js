...
export const BASE_VIEW_PROPS = {
  ...
  // 第20弾: 小川（Gシートのタイルを合成した水路スプライト）。敷地左奥の芝の上を流れる。
  // アンカーは接地点（下端中央）で、スプライトはそこから -w/+l 方向へ約1.5×3.0ユニット
  // 広がる。旧位置(-8.15)は footprint の w が敷地(wMin:-9)を越えて海に浮いて見えた。
  canal: { w: -7.1, l: 5.0 },
};
...
export const BASE_VIEW_GROUNDS_DECOR = [
  { key: "pond", minLevel: 1, kind: "pond", w: -0.3, l: 4.3 },
